...
<script type="text/javascript" src="<?php echo site_url .'/public/js/admin/osool_contact_us.js';?>"></script>
...
<div align="center">
<form action='<?php echo site_url;?>/osool_contact_us/save' method="post">
<table>
  <tbody>
   <tr>
    <td></td>
